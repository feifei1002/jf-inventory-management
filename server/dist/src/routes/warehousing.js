...
router.post("/", async (req, res) => {
    try {
        const { formId, date, supplierId, supplierName, contactPerson, supplierAddress, supplierTelephone, supplierFax, purchaseId, paymentTerm, invoiceNo, deliveryNote, items, } = req.body;
